...
@Component({
  selector: 'app-consulter-diplome',
  templateUrl: './consulter-diplome.component.html',
  styleUrls: ['./consulter-diplome.component.css']
})
export class ConsulterDiplomeComponent implements OnInit {
