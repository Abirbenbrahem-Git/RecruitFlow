...
public class SecurityConfiguration {
    ...
    private static final String[] WHITE_LIST_URL = {"/api/v1/auth/**",
            ...
            "/gouvernorat",
            "/candidature",
           "/candidature/{id}/download",
            "/api/CandidateProfile/add",
            "/offre/niveau",
            "/updateUser",
            "/gouvernorat/noms",
            "/candidature/refuser/{id_candidature}",
            "/offre/gouvernorat/noms",
            "/offre/gouvernorat",
            "/offre/niveau/noms",
            "/offre/gouvernorat/{nom}",
            "/offre/niveau/{noms}",
            "/accepter/{id_candidature}",
            "/candidature",
            "/NiveauGouvernorat/{gouvernorat}/{niveau}",
            "/offre/niveau/",
           // "/candidat/details",
            "/v2/api-docs",
            "/v3/api-docs",
